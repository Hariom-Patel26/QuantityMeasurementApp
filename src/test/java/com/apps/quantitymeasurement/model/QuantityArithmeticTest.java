 ...
 *
 * Tests arithmetic operations (add, subtract, divide) on Quantity, covering:
 * same-unit, cross-unit, explicit target unit, immutability,
...
public class QuantityArithmeticTest {
	...
	public void testAdd_ExplicitTarget_Yards() {
		assertEquals(new Quantity<>(0.666667, LengthUnit.YARDS),
	...
	public void testAdd_ExplicitTarget_NegativeValues() {
		assertEquals(new Quantity<>(36.0, LengthUnit.INCHES),
	...
	public void testAdd_ExplicitTarget_LargeToSmallScale() {
		assertEquals(new Quantity<>(18000.0, LengthUnit.INCHES),
	...
	public void testAdd_ExplicitTarget_PrecisionTolerance() {
		assertEquals(new Quantity<>(3.6, LengthUnit.INCHES),
	...
	public void testAdd_ExplicitTarget_Volume_Gallon() {
		assertEquals(new Quantity<>(2.0, VolumeUnit.GALLON), new Quantity<>(3.785412, VolumeUnit.LITRE)
				.add(new Quantity<>(3.785412, VolumeUnit.LITRE), VolumeUnit.GALLON));
	}

	@Test
	public void testAdd_ExplicitTarget_Weight_CrossUnit() {
		assertEquals(new Quantity<>(2000.0, WeightUnit.GRAM),
	...
	public void testSubtract_Chained() {
		assertEquals(new Quantity<>(7.0, LengthUnit.FEET), new Quantity<>(10.0, LengthUnit.FEET)
	...
	public void testSubtract_ExplicitTarget_Feet() {
		assertEquals(new Quantity<>(9.5, LengthUnit.FEET), new Quantity<>(10.0, LengthUnit.FEET)
				.subtract(new Quantity<>(6.0, LengthUnit.INCHES), LengthUnit.FEET));
	}

	@Test
	public void testSubtract_ExplicitTarget_Inches() {
		assertEquals(new Quantity<>(114.0, LengthUnit.INCHES), new Quantity<>(10.0, LengthUnit.FEET)
	...
	public void testDivide_AllCategories() {
		...
		assertEquals(2.0, new Quantity<>(10.0, WeightUnit.KILOGRAM).divide(new Quantity<>(5.0, WeightUnit.KILOGRAM)),
				EPSILON);
		assertEquals(0.5, new Quantity<>(5.0, VolumeUnit.LITRE).divide(new Quantity<>(10.0, VolumeUnit.LITRE)),
				EPSILON);
	}
	...
	public void testDivide_NoRounding_FullPrecision() {
		assertEquals(10.0 / 3.0, new Quantity<>(10.0, LengthUnit.FEET).divide(new Quantity<>(3.0, LengthUnit.FEET)),
				1e-12);
	}
	...
	public void testHelper_PerformArithmetic_BaseUnitConversion() throws Exception {
		...
		double expected = a.getUnit().convertToBaseUnit(a.getValue()) + b.getUnit().convertToBaseUnit(b.getValue());
