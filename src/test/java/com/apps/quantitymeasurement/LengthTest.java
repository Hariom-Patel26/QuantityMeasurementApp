...
class LengthTest {
	...
	void testEquality_InchesDifferent() {
		assertFalse(new Length(10.0, LengthUnit.INCHES).equals(new Length(5.0, LengthUnit.INCHES)));
	}
	...
	void testEquality_DifferentType() {
		assertFalse(new Length(1.0, LengthUnit.FEET).equals("Not a Length"));
	}

	// 10. Zero values
	@Test
	void testEquality_ZeroValues() {
		assertTrue(new Length(0.0, LengthUnit.FEET).equals(new Length(0.0, LengthUnit.INCHES)));
	}
