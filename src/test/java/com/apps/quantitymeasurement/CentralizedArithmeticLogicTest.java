...
public class CentralizedArithmeticLogicTest {
    ...
    void testValidation_CrossCategory_ConsistentAcrossOperations() {
        ...
        IllegalArgumentException ex1 =
                assertThrows(IllegalArgumentException.class, () -> length.add(rawWeight));
        assertEquals(expectedMsg, ex1.getMessage());

        IllegalArgumentException ex2 =
                assertThrows(IllegalArgumentException.class, () -> length.subtract(rawWeight));
        assertEquals(expectedMsg, ex2.getMessage());

        IllegalArgumentException ex3 =
                assertThrows(IllegalArgumentException.class, () -> length.divide(rawWeight));
