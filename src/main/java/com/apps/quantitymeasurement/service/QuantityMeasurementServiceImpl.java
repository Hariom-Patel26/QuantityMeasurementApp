...
import com.apps.quantitymeasurement.dto.QuantityDTO.IMeasurableUnit;
...
public class QuantityMeasurementServiceImpl implements IQuantityMeasurementService {
	...
	public QuantityDTO convert(QuantityDTO thisQuantityDTO, QuantityDTO targetUnitDTO) {
		...
		if (source.getUnit() instanceof com.apps.quantitymeasurement.units.TemperatureUnit) {
	...
	private IMeasurable getModelUnit(String measurementType, String unit) {
	    ...
	    switch (measurementType) {
	        ...
	        case "LengthUnit":
	            return com.apps.quantitymeasurement.units.LengthUnit.valueOf(unit);

	        case "WeightUnit":
	            return com.apps.quantitymeasurement.units.WeightUnit.valueOf(unit);

	        case "VolumeUnit":
	            return com.apps.quantitymeasurement.units.VolumeUnit.valueOf(unit);

	        case "TemperatureUnit":
	            return com.apps.quantitymeasurement.units.TemperatureUnit.valueOf(unit);
	...
	public static void main(String[] args) {
	    ...
	    IQuantityMeasurementRepository repository =
	            com.apps.quantitymeasurement.repository
